// Vendored from React Bits (https://reactbits.dev/backgrounds/shape-waves), MIT.
// Fuente: src/ts-tailwind/Backgrounds/ShapeWaves/ShapeWaves.tsx. No editar a mano:
// si hace falta cambiar comportamiento, hacerlo desde AppBackground.tsx vía props.
